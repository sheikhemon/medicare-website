    ...
    return (
        <div >
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className="header">
                <Container>
                    <Navbar.Brand to="/home">Medi Care</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <nav className="ms-auto">
                            ...
                            {user?.email ? <NavLink
                                onClick={logOut} className="link-style bg-secondary" to="/login">Log out</NavLink> :
                                <NavLink className="link-style bg-primary" to="/login">Login</NavLink>
                            }
