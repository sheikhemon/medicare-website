...
const AboutUs = () => {
    return (
        <div className="p-2">
            <h1 className="my-4 text-center fs-40 text-primary">Care Services</h1>
            <Row xs={1} md={2} className="g-4 p-4 ">
                ...
                <Col>
                    <h1 className='text-primary fw-bold pt-70'>Medicare covers the cost of treatment in public hospitals</h1>
